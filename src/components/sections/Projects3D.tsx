...
import { Folder, ChevronRight, X, Briefcase, GraduationCap, ExternalLink, Code2 } from 'lucide-react';
      ...
      <div className="container px-6">
        <ScrollReveal>
          <div className="flex items-center gap-4 mb-12">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-heading font-bold">Featured 3D Projects</h2>
              <p className="text-muted-foreground mt-1">Interactive 3D showcases of full-stack & backend applications</p>
            </div>
          </div>
        </ScrollReveal>
            ...
            <ScrollReveal key={project.title} delay={index * 0.15}>
              <TiltCard className="h-full">
                <div
                  ...
                  className="h-full w-full text-left p-8 rounded-2xl bg-gradient-to-b from-card via-card/80 to-card/40 border border-border shadow-2xl hover:shadow-primary/20 hover:border-primary/50 group relative overflow-hidden transition-all duration-500 flex flex-col justify-between cursor-pointer transform hover:-translate-y-1"
                >
                  {/* Glowing subtle blob */}
                  ...
                  <div>
                    ...
                    <div className="mb-6 p-4 rounded-xl bg-secondary/40 border border-border/50 backdrop-blur-sm">
